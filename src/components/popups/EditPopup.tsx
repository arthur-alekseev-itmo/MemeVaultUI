    ...
    return <div className="popup">
        <div className="edit-popup">
            ...
            <div className="center full-wide">
                <span className="edit-header"> {t("Edit file")} </span>
            </div>
            <div className="edit-popup-image">
                <Content image={meme} />
            </div>
            <span className="grayish"> {t("Edit tags")} </span>
            ...
            <div className="bottom-control">
                <Button onClick={() => save(tags)}> <span className="green"> {t("Save")} </span> </Button>
